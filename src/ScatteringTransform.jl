...
using Interpolations, Wavelets, Distributed, HDF5, Plots, JLD
...
include("plotting.jl")
export st, thinSt, flatten, MatrixAggrigator, plotCoordinate, reshapeFlattened, numberSkipped, logabs, maxPooling, ReLU, numScales, incrementKeeper, numInLayer,  transformMidLayer!, transformFinalLayer!, comparePathsChildren
...
"""
function st(X::Array{T}, layers::layeredTransform; nonlinear::Function=abs, subsam::Function=bspline, stType::String="full", totalScales = [-1 for i=1:layers.m+1]) where {T<:Real}
